...
import { getPageIdx, getNodeIdxClassName, BasicType, getNodeTypeFromClassName, JsonToMjml, createBlockDataByType, BlockManager, getIndexByIdx, getParentByIdx, getParentIdx, getValueByIdx, getChildIdx, getNodeIdxFromClassName, MERGE_TAG_CLASS_NAME, AdvancedType, getSameParent } from "easy-email-core";
...
const SyncScrollShadowDom = (props) => {
  ...
  useEffect(() => {
    if (ref) {
      ...
      setRoot(root2);
      reactShadowDomRetargetEvents(root2);
      if (!ref.shadowRoot)
        return;
      const onScroll = () => {
        if (!ref.shadowRoot)
...
function makeStandardContentEditable(node, blockType, idx) {
  if (isTextBlock(blockType) || isButtonBlock()) {
...
const Tabs = (props) => {
  ...
  })), props.tabBarMiddleContent, props.tabBarExtraContent)), React.Children.map(props.children, (item, index2) => {
...
const EmailEditor = () => {
  ...
  const tabPanelList = useMemo(() => [
    ...!hideEditMode ? [
      ...
      }, /* @__PURE__ */ React.createElement(EditEmailPreview, null))
    ] : [],
    /* @__PURE__ */ React.createElement(TabPane, {
      style: { height: "calc(100% - 50px)" },
      tab: /* @__PURE__ */ React.createElement(Stack, {
